...
public class FacebookUserInfoFetcher {
    ...
    public FacebookOAuth2UserInfo getUserInfo(String accessToken) {
        RestTemplate client = facebookUserInfoRestTemplate.get();
        Map<String, Object> attributes = client.getForObject("/me?access_token={access_token}&fields=id,first_name,middle_name,last_name,name,email,picture.width(250).height(250)", Map.class, accessToken);
